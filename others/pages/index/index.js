...
Page({
    ...
    wx.getSystemInfo({
      success: function (res) {
        that.setData({
          ...
          mapheight: res.screenHeight * 0.50,
  ...
  DealData: function (datalist) {
    ...
    for (var i = 0; i < datalist.length; i++) {
      ...
      txtarry[i] = {
        ...
        iscollect: datalist[i].favorite,/**是否收藏**/
        iscollectopt: false,
      };
      var siconpath = "";
  ...
  zhedieopt: function () {
    ...
    if (iszhediemap) {
      that.setData({
        mapheight: that.data.winheight * 0.50,
        iszhediemap: false,
        controls: [{
          id: 1,
          position: {
            left: 320,
            top: that.data.winheight * 0.50 - 100,
            width: 50,
            height: 50
          },
          iconPath: '/resources/icon/dingwei.png',
